...
const About = () => {
  return (
    <div className='mt-32'>
      <div className='text-4xl font-bold text-green-700 font-playFair ml-10 md:ml-0'>
        <div className=' text-center'>Creative Front-End and Web3 Developer Turning Ideas Into Digital Reality</div>
      </div>
      <div className='mt-16 text-lg text-ash font-Quicksand ml-10'>
        <div className=''>
