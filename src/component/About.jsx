...
const About = () => {
  return (
    <div className='mt-32'>
      <div className='text-5xl font-bold text-green-700 font-playFair ml-10 md:ml-0'>
        <div className='w-[600px] text-center'>Creative Front-End and Web3 Developer Turning Ideas Into Digital Reality</div>
      </div>
      <div className='mt-16 text-lg text-ash w-[700px] font-Quicksand'>
