    ...
    <div className='flex mt-20 fixed right-0 mr-5'>
      <div className='border rounded-xl px-3 py-3 xl:block hidden'>
        <div className='flex flex-col gap-7 '>
          ...
          <Link to="/message" spy={true} smooth={true} offset={-100} duration={1000}>
          <img src={Message} className='w-8 rounded-full'/>
          </Link>
          <Link to="/advantage" spy={true} smooth={true} offset={-100} duration={1000}>
      ...
      <div className='xl:hidden block  mr-4'>
        ...
        {isOpen && (
          <div className='bg-metal w-[350px] sm:w-[500px] h-screen top-0 fixed right-0 opacity-95 font-Imperial text-ash'>
