  ...
  return (
    <div id='/service' className='mt-20'>
      ...
      <div className='border p-16 mr-2 rounded-xl hover:border-green-600 mt-5'>
        ...
        <div className='text-lg font-roboto'> Blending digital intuitive designs with blockchain technology to build decentralized, user-friendly applications using tools with potentials like <span className='text-green-600 font-Chewy'>MOTOKO</span> that empowers users to interact with next generation of internet.</div>
      </div>
    </div>
  )
}
